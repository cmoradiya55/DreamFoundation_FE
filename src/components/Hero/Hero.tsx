  ...
  const events = [
    {
      ...
      title: `Tiny  Yatra`,
      description:
        "A fun-filled, experiential journey that nurtures curiosity and early learning for young minds",
      route: "/tiny-yatra",
    ...
    },
    {
      ...
      title: "Helix Academy",
      description:
        "Focused coaching and personalized support for JEE Main & JEE Advanced",
      route: "/helix-academy",
                      ...
                      return (
                        <div key={event.id} className="relative">
                          ...
                          <div
                            ...
                            tabIndex={0}
                            onClick={() =>
                              event.route && router.push(event.route)
                            }
                            onKeyDown={(e) => {
                              if (
                                (e.key === "Enter" || e.key === " ") &&
                          ...
                          >
                            <div
                              className={`relative h-32 sm:h-64 flex items-center justify-center bg-gradient-to-br ${event.gradient} bg-opacity-10 p-2 sm:p-4 md:p-6 lg:p-8 overflow-hidden`}
                            >
                              <div
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#134e4a] mb-6">
                Dream Foundation
              </h2>
              <p className="text-lg text-[#0f766e] max-w-3xl mx-auto leading-relaxed">
                Dedicated to providing quality education and opportunities to
                help individuals achieve their dreams through comprehensive
            ...
            <div className="grid md:grid-cols-3 gap-8 lg:gap-10">
              <div className="group relative bg-gradient-to-br from-teal-50 to-emerald-50 p-8 rounded-2xl border border-teal-200/50 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                ...
                <h3 className="text-xl font-bold text-[#115e59] mb-3">
                  Quality Education
                </h3>
                <p className="text-[#0f766e] leading-relaxed">
                  Comprehensive educational programs designed to meet diverse
                  learning needs and foster excellence.
                </p>
              </div>
              ...
              <div className="group relative bg-gradient-to-br from-cyan-50 to-blue-50 p-8 rounded-2xl border border-cyan-200/50 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                ...
                <p className="text-[#0f766e] leading-relaxed">
                  Regular events and workshops designed to engage, inspire, and
                  empower our vibrant community.
                </p>
              </div>
              ...
              <div className="group relative bg-gradient-to-br from-emerald-50 to-teal-50 p-8 rounded-2xl border border-emerald-200/50 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                ...
                <p className="text-[#0f766e] leading-relaxed">
                  Professional development opportunities to help individuals
                  advance and excel in their careers.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 md:gap-16">
              <div className="space-y-6">
                ...
                <p className="text-teal-50 text-lg leading-relaxed">
                  Today&apos;s students are going to face the challenges of life
                  after 15–20 years. After 15–20 years our world is going to be
                  very different with different values, different technology. We
                  need to shape our kids for upcoming world and its challenges.
                  Don&apos;t limit a child to your own learning, for he was born
                  in another time. According to Vedic traditions the purpose of
                  human life is Dharma, Artha, Kama and Moksha.
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <p className="text-teal-50 text-lg leading-relaxed">
                  The illiterate of the future will not be the one who cannot
                  read. It will be the person who does not know how to learn.
                  The foundation of every country is the education of its youth.
                  Our vision is to prepare true global citizens for the next
                  generation who can cope with both the challenges of outside
                  world and evolution of consciousness in themselves.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 md:py-20 bg-gradient-to-br from-teal-50 to-emerald-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
            ...
            <p className="text-lg text-[#0f766e] mb-10 leading-relaxed">
              ...
              their lives with Dream Foundation.
            </p>
            <Link
